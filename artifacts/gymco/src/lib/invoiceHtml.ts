...
// Kept in sync with the mobile version (artifacts/iconic-app/lib/invoiceHtml.ts) —
...
<body>
  ...
  <div class="foot">
    Generated by the Iconic Fitness website from the gym billing system. For any billing
