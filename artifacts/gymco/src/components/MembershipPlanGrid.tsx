...
import { Check, Crown, Dumbbell, Tag } from "lucide-react";
  ...
  if (orderedPlans.length === 0) {
    return (
      <div className="text-center py-16 rounded-2xl border border-dashed border-border bg-card/40">
        <div className="inline-flex items-center justify-center h-12 w-12 rounded-xl bg-lime-500/10 text-lime-600 mb-4">
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-5 items-stretch pt-6">
      {orderedPlans.map((plan) => {
        ...
        const periodLabel = periodSuffix(plan.billingPeriod);
