...
export function WowHeroSlider({
  ...
  return (
    <div
      className="relative h-[340px] md:h-[400px] w-full rounded-3xl overflow-hidden shadow-[0_30px_80px_-30px_hsl(91_56%_55%/0.55)] ring-1 ring-border/60"
    ...
    >
      <AnimatePresence mode="sync">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[hsl(91_56%_50%/0.85)] via-[hsl(91_56%_45%/0.75)] to-black/70 mix-blend-multiply" />
            ...
            >
              ...
              {active.cta && (
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 mt-4 px-4 py-2 rounded-full bg-white text-[hsl(91_56%_45%)] text-sm font-bold shadow-lg hover:scale-[1.02] active:scale-95 transition"
                >
                  {active.cta.label}
