// Self-contained printable payment receipt for a single YoActiv payment.
// This is presentation-only; the mobile payment API exposes billing records,
// not an official tax-invoice document or download URL.
...
<head>
<meta charset="utf-8" />
<title>Payment receipt ${esc(inv.billId || "")}</title>
<style>
...
<body>
  <div class="head">
    ...
    <div class="inv-title">
      ...
      <p>Payment date: ${istLabel(inv.invoiceDate)}</p>
    </div>
  </div>
  <div class="meta">
    <div>
  ...
  <div class="foot">
    Generated by the Iconic Fitness app from a gym billing-system payment record.
    This receipt is not an official tax invoice. For billing questions, please
    contact your branch${inv.branchName ? ` (${esc(inv.branchName)})` : ""}.
  </div>
</body>
</html>`;
}
